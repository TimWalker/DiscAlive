...
formatter.result({
  "duration": 101295333,
  "error_message": "cucumber.api.PendingException: TODO: implement me\n\tat com.theagiletester.discalive.step_definitions.rfid_steps.there_are_no_RFIDs_in_Proximity(rfid_steps.java:15)\n\tat ✽.Given there are no RFIDs in Proximity(DiscAlive.feature:3)\n",
  "status": "pending"
});
formatter.match({
  "arguments": [
...
formatter.result({
  "duration": 187692,
  "error_message": "cucumber.api.PendingException: TODO: implement me\n\tat com.theagiletester.discalive.step_definitions.rfid_steps.i_am_in_proximity_of_an_RFID_Tag(rfid_steps.java:27)\n\tat ✽.Given I am in proximity of an RFID Tag(DiscAlive.feature:7)\n",
  "status": "pending"
});
formatter.match({
...
formatter.result({
  "duration": 307362,
  "error_message": "cucumber.api.PendingException: TODO: implement me\n\tat com.theagiletester.discalive.step_definitions.rfid_steps.i_can_read_an_RFID_Tag(rfid_steps.java:39)\n\tat ✽.Given I can read an RFID Tag(DiscAlive.feature:11)\n",
  "status": "pending"
});
formatter.match({
...
formatter.result({
  "duration": 480676,
  "error_message": "cucumber.api.PendingException: TODO: implement me\n\tat com.theagiletester.discalive.step_definitions.rfid_steps.i_my_Android_phone_is_in_proximity_of_an_NFC_RFID(rfid_steps.java:51)\n\tat ✽.Given I my Android phone is in proximity of an NFC RFID(DiscAlive.feature:15)\n",
  "status": "pending"
});
formatter.match({
